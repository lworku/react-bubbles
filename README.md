...
A token is used for verification, for example, when logging in and verifying a user.

- [ ] What steps can you take in your web apps to keep your data secure?

Make private routes, use authentication tools for users, up-to-date software, ensure data is backed up frequently, & use tokens. 

- [ ] Describe how web servers work.

Web servers process network requests, store website information,  and use HTTP and other protocols to respond to client requests. 

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

For a Create Read Update Destroy app looks like the following when mapped with HTTP - PUT/POST is equivelent to create, GET to READ, POST/PUT to update, & destroy === destroy    
